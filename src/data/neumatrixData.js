...
export const neumatrixCategories = [
  {
    ...
    intro: "High-output LED headlight bulbs for a brighter, whiter beam with a direct H4 fit.",
    catalogueHref: "/downloads/neumatrix-automotive-led-lights-catalogue.pdf",
    products: [
      {
        name: "LED Headlights",
        tag: "Auto / Lighting",
  ...
  },
  {
    ...
    intro: "Precision projector and fog lighting for sharper, longer-range illumination.",
          ...
          },
          {
            ...
            rows: [
              ...
              [
                ...
                "Tri-color (3000K/4300K/6500K)",
                "9-16V",
                "Toyota / Honda / Universal bracket",
              ],
              [
                "G12",
                "35W",
  ...
  {
    title: "AES / NEUMATRIX - Distribution",
    intro:
      "AES's global Bi-LED projector, fog, auxiliary/laser, and matrix lighting range — sourced from the brand's 2026 catalogue.",
    catalogueHref: "/downloads/neumatrix-aes-projector-lights-catalogue.pdf",
    coverOnly: true,
    products: [
      {
        name: "AES Bi-LED Projector Lens Range",
        tag: "Auto / Lighting",
        story:
          "AES's full projector lens lineup for headlight retrofits, from compact 2-inch single-laser units to 3-inch tri-laser and TIR prism models.",
        specGroups: [
          {
            title: "Product Information",
            type: "list",
            items: [
              { label: "Product Type", value: "Bi-LED / Bi-Laser Projector Lens" },
              { label: "Brand", value: "AES" },
              { label: "Glass", value: "Blue Glass" },
              { label: "Installation", value: "Plug & Play" },
            ],
          },
          {
            title: "Model Range",
            type: "table",
            columns: ["Model", "Power", "Color Temp.", "Voltage", "Size", "LED Chip", "Driver", "Notes"],
            rows: [
              [
                "TURBO SE ULTRA",
                "55W/65W",
              ...
              [
                ...
                "12pcs+2pcs",
                "Build in driver",
                "Double Reflector · Prism lens · 30000H",
              ],
              [
                "TURBO SE ULTRA TIR",
                "70W/80W",
              ...
              [
                ...
                "6pcs+3pcs",
                "External Driver",
                "Single reflector · Tri-color · 30000H",
              ],
              [
                "TURBO LV",
                "65W/92W",
      ...
      {
        name: "AES Fog Lamp Range",
        tag: "Auto / Lighting",
        story: "Bi-LED and bi-laser fog lamps built for consistent beam spread and all-weather use.",
        specGroups: [
          {
            title: "Product Information",
            type: "list",
            items: [
              { label: "Product Type", value: "Bi-LED / Bi-Laser Fog Projector Lens" },
              { label: "Brand", value: "AES" },
              { label: "Glass", value: "Blue Glass" },
              { label: "Waterproofing", value: "IP67 across the range" },
            ],
          },
          {
            title: "Model Range",
            type: "table",
            columns: ["Model", "Power", "Color Temp.", "Voltage", "Size", "LED Chip", "Waterproof", "Notes"],
            rows: [
              [
                "FX-2",
                "40W/50W",
              ...
              [
                ...
                "9V-16V",
                "106×70×70mm",
                "6pcs-3570-55mil+3pcs-3570-55mil",
                "IP67",
                "External driver · 10m: 1200LX",
              ],
              [
                "Q2M DUAL LASER",
                "40W/60W",
                ...
                "9V-16V",
                "106×70×70mm",
                "6pcs-3570-55mil+2pcs 5050",
                "IP67",
                "External driver · 10m: 1300LX",
              ],
              [
                "FX-3 — Bi-Laser",
                "50W/60W",
              ...
              [
                ...
                "6pcs-3570+1pc 5050",
                "IP67",
                "External driver · 10m: 2500LX · All-weather",
              ],
              [
                "UF-3",
                "43W/50W",
                ...
                "9V-16V",
                "—",
                "4570-6chip-75mil LED",
                "IP67",
                "3200LM · 10m: 950-1100LX · Built-in Turbo fan",
              ],
            ],
          },
        ],
      ...
      {
        name: "AES Auxiliary & Laser Lens Range",
        tag: "Auto / Lighting",
        story:
          "Compact auxiliary and laser lens units for grille and bumper mounting, from single-laser to four-laser configurations.",
        specGroups: [
          {
            title: "Product Information",
            type: "list",
            items: [
              { label: "Product Type", value: "Auxiliary Light / Bi-Laser Lens" },
              { label: "Brand", value: "AES" },
              { label: "Glass", value: "Blue Glass" },
              { label: "Waterproofing", value: "IP67 across the range" },
            ],
          },
          {
            ...
            rows: [
              ...
              [
                ...
                "9-16V",
                "96×70×68mm",
                "6pcs+3pcs-3570-55mil",
                "IP67",
                "External driver · 10m: 1200LX",
              ],
              [
                "G-WAGEN DOUBLE LASER",
                "40W/60W",
                "6000K/Tri color",
                "9-16V",
                "96×70×68mm",
              ...
              [
                ...
                "—",
                "IP67",
                "Blue lens · External driver · 10m: 800LX",
              ],
              [
                "NV-5",
                "50W/75W",
                ...
                "—",
                "IP67",
                "Blue lens · Built in driver · 10m: 1250LX",
              ],
              [
                "NV-8",
                "80W/90W",
                ...
                "—",
                "IP67",
                "Blue lens · Built in driver · 10m: 1300LX",
              ],
              [
                "EVS-2",
                "40W",
              ...
              [
                ...
                "9V-16V",
                "84×57×57mm",
                "6pcs-3570-55mil+2pcs imported LED chips",
                "IP67",
                "External driver · 10m: 1300LX",
              ],
            ],
      ...
      {
        name: "AES Matrix LED Projector Range",
        tag: "Auto / Lighting",
        story: "Compact matrix and scanning LED projector lenses for signal and DRL-style installations.",
        specGroups: [
          {
            title: "Product Information",
            type: "list",
            items: [
              { label: "Product Type", value: "Matrix LED / Bi-Laser Projector Lens" },
              { label: "Brand", value: "AES" },
              { label: "Glass", value: "Blue Glass" },
            ],
          },
          {
            ...
            rows: [
              ...
              [
                ...
                "6pcs-3570-60×68mil",
                "External driver",
                "Waterproof IP67 · 10m: 500LX · 28000H",
              ],
              [
                "DG008",
                "50W/75W",
                ...
                "—",
                "External driver",
                "Waterproof IP67 · Blue lens · 10m: 650LX",
              ],
              [
                "P5-ULTRA",
                "35W/55W",
                ...
                "9V-16V",
                "88×54×45mm",
                "6pcs-3570-55mil+2pcs round Osram 5050",
                "Built in Driver",
                "4300LM · 10m: 650-1000LX",
              ],
              [
                "DG07 Matrix Lens",
                "30W/40W",
              ...
              [
                "DG07 Scanning Matrix Lens",
                "30W/40W",
                "6000K",
                "9-16V",
                "Short: 71×41×40mm / Tall: 91×54×45mm",
                "6pcs-3570-55mil",
                "Built in driver",
                "3500LM · 10m: 900LX",
              ],
    ...
    products: [
      {
        ...
        specGroups: [
          ...
          },
          {
            ...
            rows: [
              [
                "Antela Shock-proof Plate",
                "2 × 460 × 800",
                "Aluminium foil composite butyl film",
                "−50°C ~ +180°C",
                "25 pcs/box",
              ],
              [
              ...
              [
                "INPHIC Shock-proof Plate (Custom)",
                "As per order",
                "Aluminium foil composite butyl film",
                "−50°C ~ +180°C",
                "As per order",
              ...
              [
                "Accident Car Soundproof Blanket",
                "2.3 × 500 × 1000",
                "Non-woven composite butyl film",
                "−50°C ~ +100°C",
                "20 pcs/box",
              ],
              [
                "Low Frequency Sound Insulation King",
                "8 × 460 × 800",
                "Sound-absorbing cotton + vibration plate",
                "−50°C ~ +180°C",
                "18 pcs/box",
              ],
              [
                "Three-in-One Sound Insulation Board",
                "10 × 460 × 800",
                "Insulation cotton + aluminium foil vibration plate",
                "−50°C ~ +180°C",
                "30 pcs/box",
              ],
              [
                "Engine Room Insulation Cotton",
                "5 × 100 × 1400",
                "Aluminium foil composite insulation cotton",
                "−50°C ~ +180°C",
                "10 pcs/box",
              ],
              [
                "Sound Absorbing & Insulating Cotton",
                "10 × 1500 (Roll)",
                "Polyester fibre sound-absorbing cotton",
                "−50°C ~ +100°C",
                "As per order",
              ],
            ],
          ...
          },
          {
            ...
            rows: [
              [
                "Standard",
                "6.5 mil (165µ)",
                "Good protection, high clarity, cost-effective",
                "★★★☆☆",
                "★★★★☆",
                "5 Years",
                "Daily use · Sedan / Hatchback",
              ],
              [
                "Premium",
                "7.5 mil (190µ)",
                "Enhanced durability, self-healing, high gloss",
                "★★★★☆",
                "★★★★☆",
                "7 Years",
                "SUV / Luxury · Highway driving",
              ],
              [
                "Pro",
                "8.5 mil (215µ)",
                "Maximum protection, impact resistant, self-healing",
                "★★★★★",
                "★★★★★",
                "10 Years",
                "Performance · Off-road / Extreme",
              ],
            ],
          },
          {

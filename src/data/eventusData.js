export const eventusServices = [
  {
    title: "Decor & Styling",
    points: [
      "Theme-based mandap, stage and entrance decor",
      "Floral, fabric and lighting design",
      "Welcome boards, photo walls and seating layouts",
    ],
  },
  {
    title: "Venues & Logistics",
    points: [
      "Marriage hall and banquet bookings",
      "Destination wedding planning and coordination",
      "End-to-end vendor and timeline management",
    ],
  },
  {
    title: "Catering Services",
    points: [
      "Multi-cuisine catering coordination",
      "Live counters and traditional menu curation",
      "Staffing and service management on the day",
    ],
  },
  {
    title: "Entertainment",

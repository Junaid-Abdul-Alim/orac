    ...
    products: [
      {
        ...
        spec: "Size 40-80mm / Available fresh and dehydrated",
      ...
      },
      {
        ...
        spec: "Block, seedless, powder / Brix as required",
        origin: "Tamil Nadu, Andhra Pradesh, Karnataka",
      },
      {
        name: "Moringa Powder",
        tag: "Agri / Superfood",
      ...
      },
      {
        ...
        spec: "Purity 99.95%+ / Natural white and hulled",
      ...
      },
      {
        ...
        spec: "Pearl, Barnyard, Sorghum, Kodo / Moisture <=12%",
        origin: "Karnataka, Rajasthan, Maharashtra",
      },
      {
        name: "Papad",
        tag: "Agri / Snack",
        story: "A crisp disc of tradition, simple in form and complex in craft.",
        spec: "Urad, Moong, Rice / Custom flavour available",
      ...
      },
      {
        ...
        spec: "Grade 4-6 Suta, 6-8 Suta / Moisture <=12%",
...
export const importCategories = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        spec: "Protein >=36% / Moisture <=13%",
        origin: "Nigeria, Niger Republic",
      },
      {
        name: "Raw Cashew Nuts",
        tag: "Agri Import / Cashew",
        story: "Raw cashew connecting Indian processing factories directly with African crop at origin.",
        spec: "KOR 46-52 lbs / Moisture <=9%",
        origin: "Tanzania, Nigeria, Senegal, Cameroon",
      },
      {
        name: "Stone Flower",
      ...
      },
      {
        ...
        spec: "Moisture <=14% / Purity 98%+",
        origin: "Ethiopia, Tanzania, Myanmar",
      },
      {
        name: "Black Matpe",
        tag: "Agri Import / Pulse",
      ...
      },
      {
        ...
        spec: "Moisture <=12% / Whole and cut grade",
      ...
      },
      {
        ...
        spec: "Purity 99%+ / Oil content 48-52%",
        origin: "Chad, Nigeria, Cameroon",
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        spec: "Granules / Regrind / Contamination <=0.5%",
      ...
      },
      {
        ...
        spec: "OCC 11 / OCC 12 / Baled / Moisture <=12%",
        origin: "UAE",
      },
      {
        ...
        spec: "Purity >=98% Al / Shredded or baled",

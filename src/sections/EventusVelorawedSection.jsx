    ...
    <section className="section velorawed-section eventus-velorawed-section">
      <div className="container velorawed-layout">
        <Reveal className="partner-title">
          ...
          <img className="velorawed-logo" src={velorawedLogo} alt="VELORAWED" />
          <h2>VELORAWED</h2>
        </Reveal>
        <Reveal className="partner-copy">
          <p>
            ...
            celebrations the way they feel, not just the way they look.
          </p>
          ...
          <blockquote>A wedding lasts a day. The way it is remembered lasts a lifetime.</blockquote>
        </Reveal>
      </div>

    ...
    <section className="section velorawed-section eventus-velorawed-section">
      <div className="container velorawed-layout">
        <Reveal className="partner-title">
          ...
          <img className="velorawed-logo" src={velorawedLogo} alt="VELORAWED" loading="lazy" decoding="async" />
          <h2>VELORAWED</h2>
        </Reveal>
        <Reveal className="partner-copy">
          <p>
            VELORAWED is the photography and cinematography brand of ORAC Eventus, built to capture weddings and
            celebrations the way they feel, not just the way they look. Candid, traditional, and cinematic styles are
            delivered by a team that understands South Indian weddings inside out.
          </p>
          ...
          <blockquote>A wedding lasts a day. The way it is remembered lasts a lifetime - that is the standard VELORAWED shoots for.</blockquote>
        </Reveal>
      </div>
